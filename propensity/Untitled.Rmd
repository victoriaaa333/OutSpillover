...
```{r}
setwd("~/OutSpillover")
dat <- rbind(readRDS("cluster_results/second_propensity_neigh (new UVU U11).RDS")) 
             #readRDS("cluster_results/second_propensity_group1 (new UVU A==a) 1.RDS") #analytical var
```
