...
#### 1.1 cat vars ####
inf_model_cat_var
results = readRDS("check_results/cluster_results/inf_model_cat_var.RDS")
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = nrow, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
# 2.530 0.030 0.319 0.307 0.948

results_inf = as.data.frame(matrix(unlist(lapply(results, function(l) l$inf)), nrow = nrow, byrow = TRUE))
colnames(results_inf) <- colnames(results[[1]]$inf)
result_stats(results_inf, 1 + 1 + 2 * 1)
# 4.048 0.048 0.513 0.589 0.944

results_sp = as.data.frame(matrix(unlist(lapply(results, function(l) l$sp)), nrow = nrow, byrow = TRUE))
colnames(results_sp) <- colnames(results[[1]]$sp)
result_stats(results_sp,  1 + 1 * 0.5 + 2 * 0.5)
# 2.545 0.045 0.344 0.330 0.930

results_mixed = as.data.frame(matrix(unlist(lapply(results, function(l) l$mixed)), nrow = nrow, byrow = TRUE))
...
# inf_model_num_var
setwd("~/OutSpillover")
results = readRDS("check_results/inf_model_num_var.RDS")
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = nrow, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
#### 1.3 both vars ####
setwd("~/OutSpillover")
results =  readRDS("check_results/inf_model_both_var_w_boot.RDS")
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = nrow, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
#### 2.1 cat vars ####
# sp_model_cat_var
results = readRDS("check_results/sp_model_cat_var.RDS")
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = nrow, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
# sp_model_num_var
setwd("~/OutSpillover")
results = readRDS("check_results/sp_model_num_var_newvarpara.RDS")
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = nrow, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
# sp_model_both_var
setwd("~/OutSpillover")
results = readRDS("check_results/sp_model_both_var_w_boot_newvarpara.RDS")
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = nrow, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
