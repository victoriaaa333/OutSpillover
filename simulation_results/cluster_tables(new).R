...
#### 1.1 cat vars ####
# inf_model_cat_var
results = rbind(readRDS("simulation_results/cluster_results/inf_model_cat_var.RDS"),
                readRDS("simulation_results/cluster_results/inf_model_cat_var(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
# 2.530 0.030 0.319 0.307 0.948

results_inf = as.data.frame(matrix(unlist(lapply(results, function(l) l$inf)), nrow = 1000, byrow = TRUE))
colnames(results_inf) <- colnames(results[[1]]$inf)
result_stats(results_inf, 1 + 1 + 2 * 1)
# 4.048 0.048 0.513 0.589 0.944

results_sp = as.data.frame(matrix(unlist(lapply(results, function(l) l$sp)), nrow = 1000, byrow = TRUE))
colnames(results_sp) <- colnames(results[[1]]$sp)
result_stats(results_sp,  1 + 1 * 0.5 + 2 * 0.5)
# 2.545 0.045 0.344 0.330 0.930

results_mixed = as.data.frame(matrix(unlist(lapply(results, function(l) l$mixed)), nrow = 1000, byrow = TRUE))
...
#### 1.3 both vars ####
# inf_model_both_var
results = rbind(readRDS("simulation_results/cluster_results/threshold_x_1/inf_model_both_var(x_1).RDS"),
                readRDS("simulation_results/cluster_results/threshold_x_1/inf_model_both_var(x_1)(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
# SD = 1,  3.999 -0.001  0.376  0.276  0.836
...
#### 2.1 cat vars ####
# sp_model_cat_var
results = rbind(readRDS("simulation_results/cluster_results/sp_model_cat_var.RDS"),
                readRDS("simulation_results/cluster_results/sp_model_cat_var(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
# 2.554 0.054 0.337 0.349 0.956
# 2.547 0.047 0.342 0.348 0.951
...
#### 2.2 num vars ####
# sp_model_num_var
results = rbind(readRDS("simulation_results/cluster_results/threshold_x_1/sp_model_num_var(x_1).RDS"),
                readRDS("simulation_results/cluster_results/threshold_x_1/sp_model_num_var(x_1)(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
#### 2.3 both vars ####
# sp_model_both_var
results = rbind(readRDS("simulation_results/cluster_results/threshold_x_1/sp_model_both_var(x_1).RDS"),
                readRDS("simulation_results/cluster_results/threshold_x_1/sp_model_both_var(x_1)(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5)
...
#### 3.1 cat vars ####
# mixed_model_cat_var
results = rbind(readRDS("simulation_results/cluster_results/mixed_model_cat_var.RDS"),
                readRDS("simulation_results/cluster_results/mixed_model_cat_var(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
...
#### 3.2 num vars ####
# mixed_model_num_var
results = rbind(readRDS("simulation_results/cluster_results/threshold_x_1/mixed_model_num_var(x_1).RDS"),
                readRDS("simulation_results/cluster_results/threshold_x_1/mixed_model_num_var(x_1)(1).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5 + 3 * 0.5 + 4 * 0.5)
...
results = rbind(
                readRDS("simulation_results/cluster_results/threshold_x_1/mixed_model_both_var(x_1)(1).RDS"),
                readRDS("simulation_results/cluster_results/threshold_x_1/mixed_model_both_var(x_1)(2).RDS"))
results_nocon = as.data.frame(matrix(unlist(lapply(results, function(l) l$nocon)), nrow = 1000, byrow = TRUE))
colnames(results_nocon) <- colnames(results[[1]]$nocon)
result_stats(results_nocon, 1 + 1 * 0.5 + 2 * 0.5 + 3 * 0.5 + 4 * 0.5)
...
library(gridExtra)
png("test(3).png", height = 50*nrow(table), width = 150*ncol(table))
grid.table(table)
dev.off()
