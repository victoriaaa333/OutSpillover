...
for (i in 1:5) {
  ...
  try({
    ...
    parameters = c(parameters1, rep(0, 4))
...
saveRDS(result_G, "cluster_results/first_propensity_group.RDS")
saveRDS(result, "cluster_results/second_propensity_nocon.RDS")
saveRDS(result_N, "cluster_results/second_propensity_neigh.RDS")
saveRDS(result_G1, "cluster_results/second_propensity_group1.RDS")
