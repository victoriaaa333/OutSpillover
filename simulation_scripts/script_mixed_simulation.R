...
aa5 = rbind(readRDS("simulation_results/mixed_results/mixed.RDS"),
            readRDS("simulation_results/mixed_results/mixed(1).RDS"))
mean(aa5$std.error)
sd(aa5$estimate)
mean(aa5$estimate)
# 1 + 1 + 2*0.1 + 3 + 4*0.1 5.6
result_stats(aa5, 5.6)
# 5.658 0.058 1.243 1.251 0.952
