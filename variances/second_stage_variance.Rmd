...
```{r}
weights <- wght_matrix_second(parameters = parameters, integrand = logit_integrand, G = G, A = A, P = P, X = X, allocations = allocations)

#wght_deriv_array_second(parameters, logit_integrand, G = G, A = A, P = P, X = X, allocations = allocations)

#score_matrix_second(logit_integrand, X, A, G, P, parameters)
...
ipw_propensity_variance_second(parameters,
                        allocations,
                        causal_estimation_options = 
                          list(variance_estimation = 'robust'),
                        integrate_allocation = FALSE,
...
```{r}
P = 1
ipw_propensity_variance_second(parameter_single,
                        allocations,
                        causal_estimation_options = 
                          list(variance_estimation = 'robust'),
                        integrate_allocation = FALSE,
